...
Assignment: Color Grid
Due: 28 Mar 2017 11:00 a.m.
            ...
            for y in range(rowCol):
                for row in range(rowCol):
                    for col in range(rowCol):
                        G1.fill_cell(x+row*rowCol, y+col*rowCol, G1.get_cur_color())
                G1.get_next_color()
    else:
        print("Invalid number for square grid")
